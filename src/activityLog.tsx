...
const SEED_EVENTS: ActivityEvent[] = [
  { id: 's1', type: 'milestone_approved', icon: 'checkCircle', title: 'Milestone approved', detail: 'Drilling & casing — Borehole Bamenda North · XAF 1,400,000 released', path: '/funder/project/p1', time: '2h ago' },
  { id: 's2', type: 'bid_placed', icon: 'clipboard', title: 'New bid received', detail: 'Fon Ayuk Construction bid XAF 850,000 for Ngaoundéré pump job', path: '/contractor/job/j1', time: '5h ago' },
  { id: 's3', type: 'milestone_submitted', icon: 'camera', title: 'Proof submitted', detail: 'Emmanuel Njang submitted milestone 2 evidence for review', path: '/funder/project/p1', time: '1 day ago' },
  { id: 's4', type: 'project_funded', icon: 'lock', title: 'Funds secured', detail: 'XAF 1,200,000 moved into escrow for Clinic Renovation — Limbe', path: '/funder/project/p3', time: '3 days ago' },
  { id: 's5', type: 'listing_created', icon: 'home', title: 'Land listing verified', detail: 'Bastos plot 800m² completed document verification', path: '/land/listing/l1', time: '1 week ago' },
]
